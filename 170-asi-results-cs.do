...
local vars profit4 solvency4 paid_wage4 e_diverse4 prov_employ4 pesticide4 ///
	productivity4 land_quality4 ghg_emissions4
...
graph combine results/hist-profit4.gph results/hist-solvency4.gph  ///
	...
	results/hist-prov_employ4.gph results/hist-pesticide4.gph  ///
	results/hist-ghg_emissions4.gph results/hist-productivity4.gph  ///
	results/hist-land_quality4.gph, col(3) ysize(8) xsize(11)
graph export results/item-frequencies-presentation.pdf, as(pdf) replace 
...
title("P{it}(y=very sustainable)") legend(pos(9) ring(3))
